...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">Machine Learning</span></p></body></html>", None))
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Hamza - Toufik", None))
    # retranslateUi..